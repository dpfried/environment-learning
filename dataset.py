...
def load():
    ...
    global LOGICAL_FORM_FEATURE_INDEX, FEATURIZED_LOGICAL_FORMS, search_over_lfs
    if FLAGS.dataset == 'stacks':
        ...
        from shrdlurn.parser import LOGICAL_FORM_FEATURE_INDEX, FEATURIZED_LOGICAL_FORMS, search_over_lfs
